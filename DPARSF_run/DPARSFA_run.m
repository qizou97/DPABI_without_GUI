        ...
        if isempty(DirCo)
            ...
            if length(DirImg)==1
                if AutoDataProcessParameter.IsAllowGUI == 0 % no GUI no pop-up windows.
                    UseNoCoT1Image = 1;
                    disp('WARNNING: No co* T1 image, use NoCoT1Image instead.');
                else
...
%Do not need parfor
%%%
AutoDataProcessParameter.IsNeedReorientFunImgInteractively
AutoDataProcessParameter.IsAllowGUI
(AutoDataProcessParameter.IsNeedReorientFunImgInteractively==1) && AutoDataProcessParameter.IsAllowGUI
